...
export const searchCourse = async (req,res) => {
    try {
        ...
        if(categories) {
            // Parse categories string into array and filter out empty strings
            const categoryArray = categories.split(',').filter(cat => cat);
...
export const editLecture = async (req,res) => {
    try {
        ...
        // Set isPreviewFree to true if it's provided in the request, otherwise keep the existing value
